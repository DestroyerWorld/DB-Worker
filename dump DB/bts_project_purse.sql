...
CREATE TABLE `purse` (
  `idPurse` int NOT NULL AUTO_INCREMENT,
  `User_name` varchar(45) NOT NULL,
  `Col_transactions` int NOT NULL DEFAULT '0',
  `Received` double NOT NULL DEFAULT '0',
  `Total_balance` double NOT NULL DEFAULT '0',
  PRIMARY KEY (`idPurse`),
  KEY `Key1_idx` (`User_name`),
  CONSTRAINT `Key_pur` FOREIGN KEY (`User_name`) REFERENCES `users_accounts` (`Users_name`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `purse` VALUES (1,'Rt',5,1,10.5);
